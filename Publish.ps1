...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "Unreal.NativeTypes/Unreal.NativeTypes.csproj",
    $PackageName = "Unreal.NativeTypes",
    ...
    $NuGetPackageId = "Unreal.NativeTypes",
...
# Publish interface
$InterfaceProjectPath = "Unreal.NativeTypes.Interfaces/Unreal.NativeTypes.Interfaces.csproj"
